...
<head>
    ...
    <style>
        .drop-zone {
            position: absolute; top: 6px; width: 120px; height: 120px; 
        ...
        .img-list {
            position: absolute; height: 110px; background-color: #444;
...
<?php
    echo "<script src=http://ajax.aspnetcdn.com/ajax/jQuery/jquery-1.9.1.js ></script>";
